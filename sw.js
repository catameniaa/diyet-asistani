...
const CACHE = 'diyet-asistani-v2';
const ASSETS = [
  './', 'index.html', 'manifest.webmanifest', 'css/app.css',
  'js/core.js', 'js/data-foods.js', 'js/data-cards.js', 'js/data-ref.js', 'js/data-growth.js', 'js/calc.js', 'js/growth.js', 'js/exchange.js', 'js/foods.js',
